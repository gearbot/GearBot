...
async def get_infraction_info(*, guild_id, user_id=None, moderator_id=None, do_and=True):
    infractions = await Infraction.filter(user_id=user_id, guild_id=guild_id)
