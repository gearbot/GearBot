...
export default class Home extends Component<{}, {}> {
	render() {
		return <div class="home">
			...
			<h2>Support</h2>
			<p>Check out <a href="docs/">the docs</a>: they have a lot of information and should help you in most cases. You can also drop by the <a href="https://discord.gg/S4DBxtC">support server</a> for question, stay up to date on the updates and more.</p>
